...
class Autonomy_Final:
    ...
    def motion_planner(self):
        ...
        while not rospy.is_shutdown():
            ...
            #Keystroke of 's' indicates switch to Line Following
            if keyboard.is_pressed('s'):
                switch_flag = True
                print("Switch command received")

            # Follow wall and avoid obstacles until keystroke input is received 
            ...
            # Switch to Line Following
                ...
                print("Switching to Line following mode")  
