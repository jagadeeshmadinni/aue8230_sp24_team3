...
class Autonomy_Final:
    ...
    def __init__(self):
        ...
        self.Image_Subscriber = rospy.Subscriber("/camera/image",Image,self.camera_callback) #real
        ...
        while not rospy.is_shutdown():
            ...
            if self.cv_image is not None:
                ...
                if self.switch_flag is False:
                    ...
                    #switch_flag = (np.diff(error_front) == 0 and np.diff(error_diff) != 0 and front>2)
                    previous = error_line
